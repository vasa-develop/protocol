...
contract TokenMultiCall {
        ...
        )
    {
        ...
        ) = getErc20Data(erc20Addr);
        (string memory _erc721Name, string memory _erc721Symbol) =
            getErc721Data(erc721Addr);
    ...
    {
        (string memory _name1, string memory _symbol1, uint256 _totalSupply1) =
            getErc20Data(addr1);
        (string memory _name2, string memory _symbol2, uint256 _totalSupply2) =
            getErc20Data(addr2);
