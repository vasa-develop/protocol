...
contract ClonesMockUpgradeable is Initializable {
    ...
    function clone(address master, bytes memory initdata) public payable {
        _initAndEmit(master.clone(), initdata);
    }

    function cloneDeterministic(address master, bytes32 salt, bytes memory initdata) public payable {
